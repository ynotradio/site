...
const SAMPLE_MATCHES = [
  ...
  makeMatch('m3', 3, '1', 'Pearl Jam', 3, 'Soundgarden', 14),
  makeMatch('m4', 4, '1', 'Foo Fighters', 4, 'Weezer', 13),
  makeMatch('m33', 33, '2', 'Radiohead', 1, 'Nirvana', 2, {
    band1Votes: 2100,
    band2Votes: 950,
    endTime: PAST(30),
    winner: {
  ...
  makeMatch('m49', 49, '3', '(TBD)', 1, '(TBD)', 1, { band1: null, band2: null }),
];

const meta: Meta<typeof TournamentBracketTab> = {
  title: 'Features/MRM Bracket/TournamentBracketTab',
  component: TournamentBracketTab,
  parameters: { layout: 'fullscreen' },
  tags: ['autodocs'],
};

export default meta;
type Story = StoryObj<typeof TournamentBracketTab>;
