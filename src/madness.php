...
<div class="row">
  <div class="twelve columns">
	<a href="madness.php"><img src="https://i.imgur.com/iR1nnUk.jpg" alt="Modern Rock Madness 2018" width="930px"></a>
    <div id="mrm_text">
  <p>Download your Modern Rock Madness <?php echo date('Y'); ?> brackets <a href="https://od.lk/d/126908095_2oogV/MRM2018Bracket.pdf">here</a> and listen all week as Y-Not bands go head to head! Help your favorites advance to the next round by voting here, or if you're listening on the go, you can text your votes in to 267-293-YNOT. 
...
<!--     <p><strong>Want to sponsor a match?</strong> Some are still available <a href="/donate.php">here</a>.</p>
 -->      <div class="social">
        ...
        <div class="fb-like" data-href="http://www.ynotradio.net/madness.php?2018" data-send="true" data-width="450" data-show-faces="false"></div>
      </div>
    </div>
<?php
