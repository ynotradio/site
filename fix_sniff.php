<?php
// Simple script to fix indentation and brace problems in BrokenRequireSniff.php

$file = '/workspaces/site/src/PHP_CodeSniffer/Standards/YNotRadio/Sniffs/Files/BrokenRequireSniff.php';
$content = file_get_contents($file);

// Fix brace indentation issues in the file
$fixedContent = "<?php
...
namespace PHP_CodeSniffer\Standards\YNotRadio\Sniffs\Files;
...
echo "Fixed BrokenRequireSniff.php successfully.\n";
