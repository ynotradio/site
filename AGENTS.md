...
| **elegant-ui-design**               | When designing or building UI components, layouts, or design systems. MCP servers, libraries, design principles, and agent patterns for expert-level frontend work. |
